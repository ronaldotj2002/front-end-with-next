  ...
  return (
    <main className="flex px-6 drop-shadow-2xl lg:w-3/4">
      ...
      <section className="bg-azul-escuro hidden lg:block w-1/2 rounded-l-lg">
        <img className="p-6 m-auto" src="https://img.freepik.com/vetores-gratis/adicionar-ilustracao-do-conceito-de-usuario_114360-458.jpg?size=626&ext=jpg&ga=GA1.1.1907922262.1700266742&semt=sph" alt="icone de mergulhador" />
      </section>
