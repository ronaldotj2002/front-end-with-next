...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8 border-solid " >
  ...
  <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <p class="mt-10 text-center text-sm text-gray-500">
      Não tem conta?
      <Link href="/cadastro" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500"> Cadastre-se</Link>
    </p>
  </div>
</div>
